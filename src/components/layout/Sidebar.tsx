  ...
  return (
    <>
      ...
      <aside className="hidden md:flex md:w-56 h-screen bg-white k:bg-gray-900 border-r border-gray-200 dark:bg-gray-900 dark:border-gray-800 p-4 flex-col fixed left-0 top-0">
        ...
        {/* Scan Crop Button */}
        <button
          className="w-full bg-green-700 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-700 text-white font-medium py-2.5 px-4 rounded-lg transition-colors mt-4"
          onClick={() => {
            navigate("/dashboard");
          }}
        >
